...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        //variable to hold html element that was clicked
        let select = document.getElementById(squareNumber);
        //determines the active player and places icon
        if (activePlayer ==='X') {
        ...
        //calls the function to check for win    
        checkWinConditions();
        ...
        //returning true is needed for the computerTurn() function
        return true;
    }
