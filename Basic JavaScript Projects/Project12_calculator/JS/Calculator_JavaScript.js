//creates an object to keep track of objects
const Calculator = {
...
function Input_Decimal(dot) {
    //this ensure that accidental clickoing of the decimal point doesn't
...
function Handle_Operator(Next_Operator) {
    ...
    //when operator key is pressed we convert hte current number
    //display on the screen to a number and then store the result in
    //Cakculator.First_Operand if it doesnt already exist.
    ...
    if (First_Operand == null) {
        ...
        //in the Perform_Calculation object and the functio0n that matches the
